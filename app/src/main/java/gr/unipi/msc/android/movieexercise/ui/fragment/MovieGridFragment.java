...
public class MovieGridFragment extends BaseFragment implements MovieListView {
    ...
    public static MovieGridFragment newInstance(List<MovieListObject> movies) { // LIST<MOVIELISTOBJECT>
