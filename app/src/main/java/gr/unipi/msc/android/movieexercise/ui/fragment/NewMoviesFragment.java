...
import gr.unipi.msc.android.movieexercise.mvp.presenter.NewMoviesPresenter;
...
public class NewMoviesFragment extends BaseFragment implements NewMoviesView {
    ...
    private NewMoviesPresenter presenter;

    private List<MovieListObject> movies;

    public static NewMoviesFragment newInstance() { // LIST<MOVIELISTOBJECT>
...
//        }
    ...
    public void instantiatePresenter() {
        presenter = new NewMoviesPresenter(this, movies);
    }
