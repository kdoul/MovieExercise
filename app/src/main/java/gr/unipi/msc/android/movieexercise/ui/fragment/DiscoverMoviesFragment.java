...
import gr.unipi.msc.android.movieexercise.mvp.presenter.DiscoverMoviesPresenter;
import gr.unipi.msc.android.movieexercise.mvp.presenter.MovieListPresenter;
...
public class DiscoverMoviesFragment extends BaseFragment implements DiscoverMoviesView {
        public static final String TAG = DiscoverMoviesFragment.class.getSimpleName();
        ...
        private DiscoverMoviesPresenter presenter;

        private List<MovieListObject> movies;

        public static DiscoverMoviesFragment newInstance() { // LIST<MOVIELISTOBJECT>
...
//        }
        ...
        public void instantiatePresenter() {
            presenter = new DiscoverMoviesPresenter(this, movies);
        }
