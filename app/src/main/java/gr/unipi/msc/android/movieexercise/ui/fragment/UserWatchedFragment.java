...
import gr.unipi.msc.android.movieexercise.mvp.presenter.UserWatchedPresenter;
...
public class UserWatchedFragment extends BaseFragment implements UserWatchedView{
    public static final String TAG = UserWatchedFragment.class.getSimpleName();
    ...
    private UserWatchedPresenter presenter;

    private List<MovieListObject> movies;

    public static UserWatchedFragment newInstance() { // LIST<MOVIELISTOBJECT>

        UserWatchedFragment fragment = new UserWatchedFragment();
...
//        }
    ...
    public void instantiatePresenter() {
        presenter = new UserWatchedPresenter(this, movies);
    }
